...
build: ## Build the executable for Lambda
	echo
	GOOS=linux GOARCH=amd64 go build -o bin/add ./add
	GOOS=linux GOARCH=amd64 go build -o bin/allorders ./allorders
	GOOS=linux GOARCH=amd64 go build -o bin/userorders ./userorders
	GOOS=linux GOARCH=amd64 go build -o bin/ship ./ship
	GOOS=linux GOARCH=amd64 go build -o bin/updatestatus ./updatestatus
	echo
