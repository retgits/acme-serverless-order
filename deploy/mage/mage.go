...
var eventBridgeLambdas = []string{"lambda-order-all", "lambda-order-users", "lambda-order-eventbridge-add", "lambda-order-eventbridge-ship", "lambda-order-eventbridge-update"}
var sqsLambdas = []string{"lambda-order-all", "lambda-order-users", "lambda-order-sqs-add", "lambda-order-sqs-ship", "lambda-order-sqs-update"}
